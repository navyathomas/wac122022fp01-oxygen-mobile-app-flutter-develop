...
import 'package:oxygen/views/shimmers/widgets/horizontal_category_list.dart';
...
class CategoryDetailedShimmer extends StatelessWidget {
  const CategoryDetailedShimmer({Key? key}) : super(key: key);
