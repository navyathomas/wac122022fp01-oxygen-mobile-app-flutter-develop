...
class SelectDistrictWidget extends StatelessWidget {
  const SelectDistrictWidget({Key? key, required this.serviceRequestProvider})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomDropdown<String>(
      ...
      onChange: (value) => serviceRequestProvider
        ..getDistrictValueFromLabel(value)
      ...
      items: List.generate(
        serviceRequestProvider.districtList.length,
        (index) => DropdownItem(
          value: serviceRequestProvider.districtList[index].label ?? '',
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  serviceRequestProvider.districtList[index].label ?? '',
      ...
      initialValue: serviceRequestProvider.districtLabel ?? Constants.selectDistrict,
    );
  }
}
